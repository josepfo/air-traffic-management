...
public class AgenteInterface extends Agent implements ExampleChart<BubbleChart> {
    ...
    private double[] xData_AA=new double[] {0.0,0.0,0.0,0.0,5000.0,5000.0};
    private double[] yData_AA=new double[] {0.0,0.0,5000.0,5000.0,5000.0,5000.0};
    private double[] bubbleData_AA = new double []{3,3,3,3,3,3};
    private double[] bubbleData_AA_AP = new double []{120,120,120,120,120,120};
    private int iAA=0;
    private double[] xData_AE=new double[] {0.0,0.0,5000.0,7500.0};
    private double[] yData_AE=new double[] {0.0,5000.0,5000.0,2500.0};
